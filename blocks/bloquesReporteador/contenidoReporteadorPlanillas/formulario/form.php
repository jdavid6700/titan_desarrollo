...
class Formulario {
    ...
    function formulario() {
        ...
        $esteCampo = "marcoFormularioPrincipal";
        $atributos ['id'] = $esteCampo;
        $atributos ["estilo"] = "jqueryui";
        $atributos ['tipoEtiqueta'] = 'inicio';
        $atributos ["leyenda"] = "PLANTILLAS";
        ...
        // -----------------CONTROL: Botón ----------------------------------------------------------------
        $esteCampo = 'botonRegistrarPlantilla';
        $atributos ["id"] = $esteCampo;
        ...
        $atributos ['cadena_sql'] = $this->miSql->getCadenaSql("consultarRegistrosDePlantilla");
        ...
        . '<thead style="display: table-row-group"><tr><th>' . "NOMBRE" . '</th><th>' . "DESCRIPCIÓN" . '</th> <th>' . "NUMERO DE PLANTILLA" . '</th> <th>' . "TIPO DE PLANTILLA" . '</th><th>' . "ESTADO" . '</th><th>' . "VER DETALLE" . '</th><th>' . "MODIFICAR" . '</th><th>' . "ACTIVAR" . '</th></tr></thead>
        ...
        if (!empty($matrizItems)) {
            while ($i < $longitud) {
                ...
                $variableMOD .= "&tipo=" . $matrizItems[$i][3];
                $variableMOD .= "&nombrePlantilla=" . $matrizItems[$i][1];
                $variableMOD .= "&descripcionPlantilla=" . $matrizItems[$i][2];
