...
class Formulario {
    ...
    function formulario() {
        ...
        $esteCampo = "marcoFormularioAsociarPersona";
        $atributos ['id'] = $esteCampo;
        ...
        // -----------------CONTROL: Botón ----------------------------------------------------------------
        $esteCampo = 'botonRegistrarReporte';
        $atributos ["id"] = $esteCampo;
        ...
        . '<thead style="display: table-row-group"><tr><th>' . "CÓDIGO DEL REPORTE" . '</th><th>' . "REPORTE" . '</th> <th>' . "TIPO DE PLANTILLA" . '</th><th>' . "VER DETALLE" . '</th></tr></thead>
